...
const Giscus = ({ mapping }: Props) => {
  ...
  return (
    <div className="pt-6 pb-6 text-center text-gray-700 dark:text-gray-300">
      {enableLoadComments && <button className="text-white hover:text-secondary_two" onClick={LoadComments}><FontAwesomeIcon icon={["fas", "comment-dots"]} className="text-white hover:text-secondary_two" />&nbsp;Click to Load Comments</button>}
